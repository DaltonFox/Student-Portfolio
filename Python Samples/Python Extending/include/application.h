...
namespace ssuge
{
	...
	protected:
		...
		/// The script manager -- used to embed a Python Interpreter for script execution
	...
	protected:
		...
		/// Our callback that is called when a key event occurs (this will likely change when we have an InputManager)
